      ...
      <div className="grid-2" style={{ alignItems: 'center' }}>
        <div>
          <p style={{ marginBottom: '1rem' }}>
            BAKYAM TEC is a specialized software consulting firm focusing exclusively on the <strong>Microsoft Power Platform</strong>, modern cloud applications, and advanced analytics solutions. We help organizations streamline operations through rapid, scalable enterprise development.
          </p>
          <p>
